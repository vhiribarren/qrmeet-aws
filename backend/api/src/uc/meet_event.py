...
class MeetService:
    ...
    def __init__(self, code_service: CodeGeneratorService, user_service: UserRegistrationService,
    ...
    def meet_other(self, from_phone_id: str, encounter_meet_id: str) -> MeetInfo:
        ...
        try:
            scanned_phone_id = self.user_service.get_phone_id(encounter_meet_id)
            if from_phone_id == scanned_phone_id:
                meet_result = MeetResult.OWNER
            elif scanned_phone_id is None:
